  ...
  <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0"  id="content_padding" style="background:#FFFFFF; padding: 24px;  width: 100%; max-width: 640px;">
    <tr>
      <td style="font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 15px; color: #222;">
         ...
         <p  style="font-family: serif; font-size: 60px; line-height:  60px; margin-bottom: 12px; color: #343333; text-align: center; margin-top: 24px;" class="header_title" >Congratulations,</p>

  <p  style="font-family:  Helvetica Neue, Helvetica, Arial, sans-serif;  margin: 0 auto; text-align: center; margin-bottom: 24px; max-width: 500px; font-size:19px;" >you're a WINNER baby!</p>
...
<p>Winners will receive a 1-year license for Hindenburg's Journalist Pro courtesy of <a href="https://hindenburg.com/?&utm_source=canpodawards&utm_medium=email&utm_campaign=winner_announce" style='color: #e41f3a;'>Hindenburg</a> via a seperate email shortly.</p>

<p>A press release is a great way to spread the word of this incredible achievement. Our in house copywriter has drafted a template for you to use if you’d like to share it with your local network and media. <a href="http://bit.ly/winnertemplate" style='color: #e41f3a;'>http://bit.ly/winnertemplate</a></p>

<p>We have also created a set of graphics for you to promote this auspicious occasion </p>

<p><strong>Please do not post about this announcement until after 9pm on Aug 27th</strong>.</p>
