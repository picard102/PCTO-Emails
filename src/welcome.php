...
<head>
  ...
  <?php
    $css = file_get_contents('welcome.css');
...
<table class="locations">
    ...
    <td>
        ...
        <h5>Bettys' Upstairs</h5>
        <span class="adr">
          <span class="street-address">240 King St E</span><br>
          <span class="locality">Toronto</span>,
          <abbr class="region" title="Ontario">ON</abbr>
...
<p>Enter the draw to win either a 2-year HJP licence or limited edition messenger bag at Hindenburg’s booth.</p>
  ...
  <tr>
    <td class="main-content">
      ...
      <h3>Rules</h3>
<ul>
<li><p><strong font-weight: bold;">PodCamp should be your experience.</strong> You get out of it what you put in. This event is to you what you make it! Be sure to branch out and explore instead of sticking with friends just cause it's comfortable. Find your own direction.</p></li>
<li><p><strong font-weight: bold;">PodCamp is an unconference.</strong> The agenda is fluid. If you have a session idea last minute, we have breakout rooms for impromptu sessions.</p></li>
