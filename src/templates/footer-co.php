...
<table class="footer">
  ...
  <td class="fill"></td>
    <td class="footer-body">
      ...
      <p>This message was sent to -EMAIL- and intended for -FNAME-. You are reciving this becuase you were included on a speaking proposal submitted to PodCamp Toronto.</p>
    </td>
  </tr>
</table>
    ...
    <td class="logo_col">
        <img src="http://podcamptoronto.com/external/img/raster/2019/emails/logo-17-w.png">
    </td>
  </tr>
